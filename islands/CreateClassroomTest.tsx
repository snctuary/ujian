	...
	return (
		<div class="flex flex-col px-4 gap-3 no-scrollbar">
			...
			<div class="flex gap-2">
				<button
					class="flex grow justify-center items-center gap-2 bg-black rounded-full p-3 text-white font-semibold fill-current"
					onClick={addQuestion}
					type="button"
				>
					<svg
				...
				<button
					class="flex justify-center items-center bg-black rounded-full p-3 text-white font-semibold fill-current size-14"
					onClick={createTest}
					type="button"
				>
					<div>
