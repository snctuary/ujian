...
import { ClassroomItemV2 } from "~/components/ClassroomItemV2.tsx";
...
export function ClassroomListV2({ classrooms }: Props) {
	...
	return (
		<div class="flex flex-col size-full">
			<div
				class="flex flex-col gap-2 grow overflow-y-auto no-scrollbar"
				f-client-nav={false}
			>
			...
			<div class="flex py-2 gap-2 fill-slate-400 order-first">
